...
<footer class="main-footer">
      <strong>Copyright &copy; 2023 <a href="https://adminlte.io">Sistema de Carnetización</a>.</strong>
      All rights reserved.
...
<script src="<?= base_url('public/Admin/plugins/jquery/jquery.print.js') ?>"></script>
<!-- jQuery UI 1.11.4 -->
...
<script type="text/javascript" src="<?= base_url('public/js/ext/adapter/ext/ext-base.js')?>"></script>
  <script src="<?= base_url('public/js/ext/ext-all.js')?>"></script> 
<script src="<?= base_url('public/js/tabla/Exporter-all.js')?>"></script>




<script type="text/javascript">
  var base_url ="http://localhost/Carnet/" ;
</script>
