...
Ext = {version: "3.2.1", versionDetail: {major: 3, minor: 2, patch: 1}};
...
(function() {
   ...
   Ext.apply(Ext, {SSL_SECURE_URL: c && r ? 'javascript:""' : "about:blank", isStrict: l, isSecure: c, isReady: false, enableGarbageCollector: true, enableListenerCollection: false, enableNestedListenerRemoval: false, USE_NATIVE_JSON: false, applyIf: function(C, D) {
         if (C) {
            for (var e in D) {
...
(function() {
   ...
   (function() {
      ...
      Ext.lib.Dom = {isAncestor: function(j, k) {
            var i = false;
            j = Ext.getDom(j);
            k = Ext.getDom(k);
            if (j && k) {
   ...
   Ext.lib.Event = function() {
      var w = false, g = {}, A = 0, p = [], d, C = false, k = window, G = document, l = 200, s = 20, B = 0, r = 0, i = 1, m = 2, t = 2, x = 3, u = "scrollLeft", q = "scrollTop", f = "unload", z = "mouseover", F = "mouseout", e = function() {
         var H;
      ...
      function D() {
         var I = false, N = [], L, K, H, J, M = !w || (A > 0);
         if (!C) {
            C = true;
            for (K = 0; K < p.length; ++K) {
               H = p[K];
               if (H && (L = G.getElementById(H.id))) {
                  if (!H.checkReady || w || L.nextSibling || (G && G.body)) {
                     J = H.override;
                     L = J ? (J === true ? H.obj : J) : L;
                     H.fn.call(L, H.obj);
                     p.remove(H);
                     --K
                  } else {
      ...
      var y = {extAdapter: true, onAvailable: function(J, H, K, I) {
   ...
   Ext.lib.Ajax = function() {
      ...
      function e(t, s, r, q) {
         return{tId: t, status: r ? -1 : 0, statusText: r ? "transaction aborted" : "communication failure", isAbort: r, isTimeout: q, argument: s}
      }
      function j(q, r) {
      ...
      function o(q, w) {
         ...
         return{tId: q.tId, status: r ? 204 : u.status, statusText: r ? "No Content" : u.statusText, getResponseHeader: function(s) {
               return A[s.toLowerCase()]
            }, getAllResponseHeaders: function() {
               return v
            }, responseText: u.responseText, responseXML: u.responseXML, argument: w}
      }
      function n(q) {
         if (q.tId) {
            k.conn[q.tId] = null
      ...
      var k = {request: function(q, s, t, u, y) {
            if (y) {
         ...
         }, useDefaultHeader: true, defaultPostHeader: "application/x-www-form-urlencoded; charset=UTF-8", useDefaultXhrHeader: true, defaultXhrHeader: "XMLHttpRequest", poll: {}, timeout: {}, conn: {}, pollInterval: 50, transactionId: 0, abort: function(t, v, q) {
   ...
   (function() {
      ...
      g.Anim = {motion: function(n, l, o, p, k, m) {
      ...
      g.AnimBase.prototype = {doMethod: function(k, n, l) {
            var m = this;
            ...
            Ext.apply(r, {isAnimated: false, startTime: null, el: Ext.getDom(l), attributes: p || {}, duration: o || 1, method: k || g.Easing.easeNone, useSec: true, curFrame: 0, totalFrames: s.fps, runAttrs: {}, animate: function() {
      ...
      Ext.lib.AnimMgr = new function() {
         ...
         Ext.apply(o, {fps: 1000, delay: 1, registerElement: function(q) {
               l.push(q);
               ++k;
               q._onStart.fire();
               o.start()
      ...
      g.Easing = {easeNone: function(l, k, n, m) {
            return n * l / m + k
      ...
      (function() {
         ...
         Ext.apply(g.Motion.prototype, {setAttr: function(o, s, r) {
   ...
   (function() {
      ...
      Ext.apply(f.Easing, {easeBoth: function(k, j, m, l) {
   ...
   (function() {
      ...
      Ext.apply(h.ColorAnim.prototype, {getAttr: function(m) {
            var o = this, n = o.el, p;
            if (i.test(m)) {
   ...
   (function() {
      ...
      Ext.apply(d.Scroll.prototype, {doMethod: function(g, m, h) {
